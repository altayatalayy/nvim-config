return {
...

    {
        ...
        config = function()
            ...
            --[[ vim.list_extend(servers, { 'jdtls', 'haskell-language-server' }) ]]
            --[[ mason_lspconfig.setup({ ensure_installed = servers }) ]]
            mason_lspconfig.setup({ ensure_installed = { "jdtls" }, automatic_installation = true })
